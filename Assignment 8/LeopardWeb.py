...
if user == "Student":
    ...
    while task != "4": #While loop allows student to pick their availableactions and runs cooresponding method until they exit the program
        print("\nPlease select the number with your desired action:")
...
#     if user == "Student":
#         print("1)Search Courses \n2)Add/Drop Course \n3)Print Schedule \n4)Logout \n")
#         return "1)Search Courses \n2)Add/Drop Course \n3)Print Schedule \n4)Logout \n"

#     #Instructor Methods
#     elif user == "Instructor":
#         print("1)Print Schedule \n2)Print Classlist \n3)Search for Courses \n4)Assign one course to each instructor and search based on course \n5)Logout \n")
#         return "1)Print Schedule \n2)Print Classlist \n3)Search for Courses \n4)Assign one course to each instructor and search based on course \n5)Logout \n"

#     #Admin Methods
#     elif user == "Admin":
#         print("1)Add course to System \n 2)Remove course from system \n 3)Add/Remove user \n 4)Add/Remove student from course  \n5)Search and Print Course Roster \n6)Logout \n")
#         return "1)Add course to System \n 2)Remove course from system \n 3)Add/Remove user \n 4)Add/Remove student from course  \n5)Search and Print Course Roster \n6)Logout \n"
...
# menu(user, name, surname, ID, task)
